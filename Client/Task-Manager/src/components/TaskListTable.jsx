            ...
            <table className='min-w-full'>
                <thead>
                    <tr className='text-left'>
                        <th className='py-3 px-4  text-gray-800 font-bold text-[13px]'>Task</th>
                        <th className='py-3 px-4 text-gray-800 font-bold text-[13px]'>Status</th>
                        <th className='py-3 px-4 text-gray-800 font-bold text-[13px]'>Priority</th>
                        <th className='py-3 px-4 text-gray-800 font-bold text-[13px]'>created On</th>
                    </tr>
                </thead>
                <tbody>
                    {tableData.map((task) => (
                        <tr key={task._id} className='border-t border-gray-200'>
                            ...
                            <td className='py-4 px-4'>
                                <span className={`px-2 py-1 test-us rounded inline-block ${getStatusBadgeColor(task.status)}`}>{task.status}</span>
                            </td>
                            <td className='py-4 px-4'>
                                <span className={`px-2 py-1 test-us rounded inline-block ${getPriorityBadgeColor(task.priority)}`}>{task.priority}</span>
                            </td>
